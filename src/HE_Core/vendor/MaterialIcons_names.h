// Generated from 'EditorDeps/Fonts/MaterialIcons-Regular.codepoints' by scripts/embed_icon_names.py — do not edit.
// 2234 icon names, sorted, for a binary search.
#pragma once
#include <cstdint>
struct HEIconName { const char* name; std::uint32_t cp; };
static const HEIconName MaterialIcons_names[] = {
    { "10k", 0xE951 },
    { "10mp", 0xE952 },
    { "11mp", 0xE953 },
    { "123", 0xEB8D },
...
static const unsigned int MaterialIcons_name_count = 2234;
